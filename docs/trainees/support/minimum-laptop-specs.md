...
These laptops are the recommended specs that we expect students to use to complete the [Fundamentals ](../fundamentals/)and [Software Development Courses](../../archive/archived-pages/full-stack-course/)
